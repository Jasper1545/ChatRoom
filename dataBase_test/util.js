    ...
    switch(size){
        ...
        case 2:
            ...
            for(var i=0;i<strs_1.length;i++) {
                if(sizeOf(strs_1[i]) >0){
                    var strs_2 = strs_1[i].split("|");
                    var obj_2 = {};
                    ...
                    if(strs_1[i+1]) {
                        console.log("size ------------" + strs_1[i] + ":" + strs_1[i+1]);
                        obj_1[strs_1[i]] = strs_1[i+1];
                        i = i+1;
                    }            
                }
            }
        ...
        case 3:
            ...
            for(var i=0;i<strs_1.length;i++) {//-----------------------
                if(sizeOf(strs_1[i]) >0){
                    ...
                    for(var j=0;j<strs_2.length;j++) {//------------------
                        if(j!=strs_2.length-1){
                            if(sizeOf(strs_2[j])>0) {
                                var strs_3 = strs_2[j].split("*");
                                var obj_3 = {};
                                for(var h=0;h<strs_3.length;h++) {//-------------
                                    if(h!=strs_3.length-1){
                                        obj_3[strs_3[h]] = strs_3[h+1];
                                    }else {
                                        obj_2[strs_3[h]] = copy(obj_3);// 'table_1':table_1
                                    }
                                }
                            }else {
                                if(strs_2[j+1]) {
                            ...
                            obj_1[strs_2[j]] = copy(obj_2);//'List_1':tableList
                        }
                    }
                }else {
                    if(strs_1[i+1]) {
                    ...
                    for(var j=0;j<strs_2.length;j++) {//------------------
                        if(j!=strs_2.length-1){
                            if(sizeOf(strs_2[j])>0) {
                                ...
                                for(var h=0;h<strs_3.length;h++) {//-------------
                                    if(h!=strs_3.length-1){
                                        if(sizeOf(strs_3[h])>0) {
                                            var strs_4 = strs_3[h].split("~");
                                            var obj_4 = {};
                                            for(var k=0;k<strs_4.length;k++){
                                                if(h!=strs_4.length-1){   
                                                    if(strs_4[k+1]){
                                                        obj_4[strs_4[k]] = strs_4[k+1];
                                                        k = k+1;
                                                    }else{
                                                        obj_3[strs_4[k]] = copy(obj_4);
                                                    }   
                                                }else {
                                                    obj_3[strs_4[k]] = copy(obj_4);// 'table_1':table_1
                                                }
                                            }
                                        }else {
                                            if(strs_3[h+1]) {
